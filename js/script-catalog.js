...
window.onload = function () {
    ...
    document.querySelector('.catalog').style.paddingTop = document.querySelector('.header').offsetHeight + 'px';

    // Catalog filters

    const filtersCatalogBtns = document.querySelectorAll('.filters-catalog__item');

    filtersCatalogBtns.forEach(item => {
        item.addEventListener('click', e => {
            if (!item.classList.contains('_active')) {
                if (item.classList.contains('filters-catalog__item--main')) {
                    document.querySelector('.filters-catalog__item--main._active').classList.remove('_active');
                    item.classList.add('_active');
                } else {
                    document.querySelector('.filters-catalog__item--additionally._active').classList.remove('_active');
                    item.classList.add('_active');
                }
            }
        });
